...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:5173",
    # "https://nama-project-anda.vercel.app",  <-- UNCOMMENT DAN ISI NANTI SETELAH DEPLOY FRONTEND
]
...
CSRF_TRUSTED_ORIGINS = [
    "http://localhost:5173",
    # "https://nama-project-anda.vercel.app",  <-- UNCOMMENT DAN ISI NANTI
    # "https://nama-backend-anda.up.railway.app", <-- UNCOMMENT DAN ISI NANTI
]
